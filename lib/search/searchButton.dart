...
class _SearchButtonState extends State<SearchButton> with SingleTickerProviderStateMixin {
  ...
  Future write()async{  
    ...
    try {
      await c.write(utf8.encode(widget.title), withoutResponse: c.properties.writeWithoutResponse);
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(borderRadius),
              color: isExpanded ? 
                Color.fromRGBO(156, 230, 167, 1)
              : 
                Color.fromARGB(255, 232, 246, 170),
                   
          ),
          child: Center(
            child: Text(
              widget.title=="call"?"call":"move to bed",
              style: TextStyle(
                fontSize: 25,
